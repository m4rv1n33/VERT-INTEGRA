...
<style lang="postcss">
	.tooltip {
		--border-size: 1px;
		@apply fixed bg-panel text-foreground border border-separator shadow-lg shadow-black/40 text-xs rounded-md pointer-events-none z-[999] max-w-xs break-words whitespace-normal;
		@apply px-3 py-1.5;
	}
